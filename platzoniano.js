...
//si se usa export default al importarlo no es necesario colocar la funcion dentro de llaves
//se importa usando import + nombre
//si exportamos con export
//se debe importar el objeto entre llaves import platzom {platzoniano} from el modulo 'platzom'
...
function platzom(str) {
  ...
  // Por ultimo, si la palabra original es un palÃ­ndromo,
